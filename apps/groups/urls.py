...
urlpatterns = patterns('apps.groups.views',
       ...
       url(r'^(?P<group_id>[a-f0-9]{24})/give_admin_right/(?P<user_id>[a-f0-9]{24})/$', 'give_admin_right', name='give_admin_right'),
       url(r'^(?P<group_id>[a-f0-9]{24})/remove_admin_right/(?P<user_id>[a-f0-9]{24})/$', 'remove_admin_right', name='remove_admin_right'),
       url(r'^(?P<group_id>[a-f0-9]{24})/remove_member/(?P<user_id>[a-f0-9]{24})/$', 'remove_member', name='remove_member'),
       ...
       url(r'^(?P<group_id>[a-f0-9]{24})/invite/(?P<user_id>[a-f0-9]{24})/$', 'send_invite', name='send_invite'),
       url(r'^(?P<group_id>[a-f0-9]{24})/invite/(?P<user_id>[a-f0-9]{24})/cancel/$', 'cancel_invite', name='cancel_invite'),
       url(r'^(?P<group_id>[a-f0-9]{24})/invite/take/$', 'invite_take', name='invite_take'),
       url(r'^(?P<group_id>[a-f0-9]{24})/invite/refuse/$', 'invite_refuse', name='invite_refuse'),
       url(r'^(?P<group_id>[a-f0-9]{24})/request/cancel/$', 'cancel_request', name='cancel_request'),
